...
def create_denoising_video(source_dir='/home/yujiro/venv/diffusion_model/data', output_path='/home/yujiro/venv/diffusion_model/data/denoising_process.mp4', fps=8):
    """
